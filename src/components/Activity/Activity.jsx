...
const Activity = () => {
  ...
  const [tabData_1, setTabData1] = useState([]);
  const [tabData_2, setTabData2] = useState([]);
  const [tabData_3, setTabData3] = useState([]);
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        setData(res.data);
        setTabData1(res.data.tabData_1);
        setTabData2(res.data.tabData_2);
        setTabData3(res.data.tabData_3);
