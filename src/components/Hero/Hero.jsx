...
const Hero = () => {
  ...
  const createButton =
    userAccountId === 'chatafisha_nft_marketplace.testnet' ||
    userAccountId === 'chatafisha_marketplace.near' ? (
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-12 col-lg-12">
            ...
            <h1 className="mt-4">
              Unlocking a Sustainable Future One <span>Carbon-Backed NFT</span>{' '}
              at a Time
            </h1>
            <p>{data.content}</p>
